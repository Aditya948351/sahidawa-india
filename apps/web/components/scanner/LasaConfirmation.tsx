...
export default function LasaConfirmation({
    ...
    return (
        <div className="animate-in fade-in zoom-in absolute inset-0 z-50 flex items-center justify-center bg-black/80 p-4 backdrop-blur-md duration-300">
            <div className="w-full max-w-sm rounded-3xl border border-orange-500/30 bg-slate-900 p-6 shadow-2xl">
                ...
                <p className="mb-6 text-center text-sm font-medium text-slate-300">
                    The medicine you scanned sounds or looks very similar to another medicine.
                ...
                <div className="mb-6 rounded-2xl border border-slate-700 bg-slate-800 p-4">
                    ...
                    <div className="relative flex items-center justify-center py-2">
                        ...
                        <div className="relative bg-slate-800 px-3 text-xs font-bold text-orange-400 uppercase tracking-wider">
                            Conflicts With
                        </div>
                    </div>
